...
NSString * const SNLNetworkInterfaceManagerInterfaceDidChange = @"SNLNetworkInterfaceManagerInterfaceDidChange";

@implementation SNLNetworkInterfaceManager {
}
...
- (void)updateInterfaceInfo {
    ...
    if (_monitoring && (_WiFiValid != previousWiFi || _WWANValid != previousWWAN)) {
        [[NSNotificationCenter defaultCenter] postNotificationName:SNLNetworkInterfaceManagerInterfaceDidChange object:self];
        _monitoring = NO;
    }
}
