...
- (void)udpSocket:(GCDAsyncUdpSocket *)arg1 didNotSendDataWithTag:(long)arg2 dueToError:(NSError *)arg3;
- (void)udpSocket:(GCDAsyncUdpSocket *)arg1 didSendDataWithTag:(long)arg2;
