...
@interface GCDAsyncUdpSocket : BaseObject
{
    ...
    id userData;
    id <GCDAsyncUdpSocketDelegate> _delegate;
}
...
+ (void)ignore:(id)arg1;
@property __weak id <GCDAsyncUdpSocketDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
...
- (id)addressesWithHost:(id)arg1 port:(unsigned short)arg2;
- (BOOL)preOp:(id *)arg1;
